...
同类对象聚集测试
聚类测试
可视化：ggraph、ggnet2、ggnetwork、network3D
...
```{r 重复关系检查}
hero_network %>% 
  distinct() -> hero_network
hero_network_clear <- hero_network[!duplicated(t(apply(hero_network, 1, sort))),]
hero_network_clear #删除两个hero相同的关系
```
